...
'''
This HarvurdSender sometimes loses count of sequence numbers.
'''


class HarvurdSender(BasicSender.BasicSender):
    def __init__(self, dest, port, filename):
        super(HarvurdSender, self).__init__(dest, port, filename)
...
if __name__ == "__main__":
    def usage():
        print "BULLDOGS-TP Harvurd Interactive Sender"
    ...
    s = HarvurdSender(dest, port, filename)
    try:
        s.start()
