...
def tests_to_run(forwarder):
    ...
    SackRandomDropTest.SackRandomDropTest(forwarder, "picture.jpeg")
...
class Packet(object):
    def __init__(self, packet, address, start_seqno_base, sackMode):
        ...
        try:
            pieces = packet.split('|')
            self.msg_type, self.seqno_str = pieces[
                                            0:2]  # first two elements always treated as msg type and seqno
    ...
    def update_packet(self, msg_type=None, seqno=None, data=None, full_packet=None,
...
if __name__ == "__main__":
    ...
    def usage():
        print "Forwarder/Test harness for BULLDOGS-TP"
